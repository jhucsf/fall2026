...
Also note that the transformation is expected to handle arbitrary
distances, even if their absolute value is greater than or equal to
the width of the image. For example, if an image is 800 pixels wide,
a wrap distance of 800 should be treated as 0, a wrap distance of 801
should be treated as 1, and so forth.
